...
if __name__ == "__main__":
    ...
    paramore_spec = {
        ...
        'defects': {'value': str, 'input': 'multi', 'options': ['trenching', 'micromasking', 'microdeposits', 'surface', 'tails', 'mask_gone', 'walls_rough', 'undercut', 'dirt']},
    ...
    ds.sort_by(files, 'OM')
    window = EtchCycler(SuperEtchtest, files, dbconn, paramore_spec, 'etchtests')
    window.show()
